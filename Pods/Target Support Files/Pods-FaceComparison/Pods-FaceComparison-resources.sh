...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/AMSmoothAlert/AMSmoothAlert/assets/checkMark.png"
  install_resource "${PODS_ROOT}/AMSmoothAlert/AMSmoothAlert/assets/checkMark@2x.png"
  install_resource "${PODS_ROOT}/AMSmoothAlert/AMSmoothAlert/assets/crossMark.png"
  install_resource "${PODS_ROOT}/AMSmoothAlert/AMSmoothAlert/assets/crossMark@2x.png"
  install_resource "${PODS_ROOT}/AMSmoothAlert/AMSmoothAlert/assets/info.png"
  install_resource "${PODS_ROOT}/AMSmoothAlert/AMSmoothAlert/assets/info@2x.png"
